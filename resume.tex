...
\begin{resume}
  ...
  \begin{itemize}
  \item Multiaxial constitutive behavior of an interstitial-free steel: measurements through X-ray and digital image correlation, \underline{Y. Jeong}, M. Iadicola, T. Gn\"{a}upel-Herold, A. Creuziger (Under NIST's internal review)
  \item Uncertainty in flow stress measurements using X-ray diffraction for sheet metals subjected to large plastic deformations, \underline{Y. Jeong}, T. Gn\"{a}upel-Herold, M. Iadicola, A. Creuziger (Under NIST's internal review)
